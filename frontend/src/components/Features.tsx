...
const Features: React.FC = () => {
  return (
    <section
      id="features"
      className="min-h-[70vh] flex flex-col justify-center items-center bg-[#FAF7F0] px-8 py-16"
    >
      <h2 className="text-4xl text-[#B17457] font-bold mb-12">Features</h2>
        ...
        {features.map((feature, index) => (
          ...
          >
            ...
            <img
              src={feature.image}
              alt={feature.title}
              className="w-76 h-96 object-cover transition-transform duration-500 group-hover:scale-110 group-hover:brightness-50 group-hover:grayscale"
            />
            ...
            <div className="absolute inset-0 flex flex-col justify-center items-center text-center px-4 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
              <h3 className="text-xl font-bold text-[#D8D2C2] mb-2">
                {feature.title}
              </h3>
