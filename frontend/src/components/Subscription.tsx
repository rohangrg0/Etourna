...
const Subscription: React.FC = () => {
  ...
  return (
    <section className="bg-[#0A0A0F] text-white py-24 px-8" id="subscription">
      <div className="max-w-7xl mx-auto text-center">
        ...
        <div className="flex justify-center items-center mb-16">
          <span
            className={`text-sm font-medium ${
              !isYearly ? "text-cyan-400" : "text-gray-400"
            }`}
          >
            Monthly
          </span>
          <button
            ...
            className="mx-3 w-14 h-7 bg-gray-700 rounded-full relative flex items-center transition-colors duration-300"
          >
            <span
              className={`w-5 h-5 bg-cyan-500 rounded-full absolute left-1 transition-transform duration-300 ${
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          {plans.map((plan) => (
            <div
              key={plan.name}
              className={`relative flex flex-col justify-between bg-gray-800 rounded-2xl p-10 shadow-xl hover:scale-105 transition-transform duration-300 border ${
            ...
            >
              ...
              <div>
                ...
                <ul className="text-gray-300 mb-10 space-y-3 text-left">
